...
def dashboard(
    ...
    if anio is None:
        return resumen_dashboard_institucional(db, usuario.programa_id, 0)  # sin periodos registrados todavia -> vacio
    return resumen_dashboard_institucional(db, usuario.programa_id, anio, semestre, corte)
